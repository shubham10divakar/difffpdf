...
> **PDF → Markdown** lives in a separate package, **[`pdf2md`](https://github.com/shubham10divakar/pdf2md)**
> (`pip install pdf2md`), which reuses this same from-scratch parser to convert a
> PDF's text — headings, paragraphs and tables — into Markdown.
